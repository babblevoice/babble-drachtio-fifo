...
@param { number } options.uactimeout - how long before timeout
...
class queuedcall {
  constructor( options ) {
    ...
    */
    ...
    if( undefined === this._options.waittimeout ) this._options.waittimeout = 3600 /* S */

    this._timers = {
      "waiting": setTimeout( () => { if( this._rejects.waiting ) this._rejects.waiting( "timeout" ) }, this._options.waittimeout * 1000 )
    }
  }
