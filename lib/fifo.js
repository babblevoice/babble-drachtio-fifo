  ...
  async _enterprise() {
    ...
    */
    ...
    const newuac = () => {
      ...
      let uactimeout
      if( nextcall._options.uactimeout ) uactimeout = nextcall._options.uactimeout
      else uactimeout = this._options.uactimeout

      const options = {
        "headers": {
          "Max-Forwards": "0"
        },
        "uactimeout": uactimeout,
        "entity": {
          "uri": agent.uri,
          "max": 1
        },
